...
var getStockForCompany = function(companyName, callback) {
  ...
  var url =
    QUANDL_BASE_API_URL + "/" + companyTickerCode + ".json?api_key=" + API_KEY + "&start_date=" + getYesterdayDate();
  ...
  var req = https_1.get(url, function(res) {
    ...
    res.on("end", function() {
      try {
        var body = buffer_1.Buffer.concat(chunks);
        var quandlResponse = JSON.parse(body.toString()).dataset;
        ...
        if (!quandlResponse.data || (quandlResponse.data && quandlResponse.data.length < 1))
          ...
          var stockData = new StockData(quandlResponse.column_names, quandlResponse.data[0]);
          var msg =
...
var StockData = /** @class */ (function() {
   ...
   * @memberof StockData
   */
  function StockData(columnNames, data) {
    var _this = this;
 ...
 * QUANDL base API URL.
 */
var QUANDL_BASE_API_URL = "https://www.quandl.com/api/v3/datasets/WIKI";
/**
 * Personal API Key.
 */
var API_KEY = "BPszsAzY2t7AR5YBh7kw";
/**
